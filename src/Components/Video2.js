...
function PostIndex() {
    ...
    return (
        ...
        <Container className="mt-3">
            <h1 className="judul">Edit Page Video 2</h1>
             <SidePage />
            <Row>
                <Col md="{4}">
                    <Card className="border-1 rounded shadow-sm">
                        <Card.Body>
                            <Button as={Link} to="/video2" variant="danger" className="mb-3">Logout</Button>
        	...
        	<Button as={Link} to={`/editvid2/edit/${post.id}`} variant="primary" size="sm" className="me-2">EDIT</Button>
        </td>
