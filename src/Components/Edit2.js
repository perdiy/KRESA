...
function EditPost() {
    ...
    const getPostById = async() => {
        ...
        const response = await axios.get(`http://localhost:8000/api/page3/${id}`);
        //get response data
    ...
    const updatePost = async (e) => {
        ...
        //send data to server
        await axios.put(`http://localhost:8000/api/page3/${id}`, {
            title: title,
            desc: desc,
                        ...
                        <Button as={Link} to="/dhasboard1" variant="danger" className="mb-3">Back</Button>
                            ...
                            <Form onSubmit={ updatePost }>
                                ...
                                <Form.Group className="mb-3" controlId="formBasicPassword">
                                    ...
                                    <Form.Control as="textarea" rows={3} value={desc_section2} onChange={(e) => setDesc2(e.target.value)} placeholder="Masukkan Des_section2" />
                                </Form.Group>
